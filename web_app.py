...
<main>
  ...
  <nav class="nav-tabs">
    <button id="tab-btn-obd" class="active" type="button">1. Ökobaudat Filter & Mittelwerte</button>
    <button id="tab-btn-ifc" type="button">2. IFC Material-Extraktion</button>
  </nav>

  <!-- TAB 1: ÖKOBAUDAT -->
  <section id="tab-obd" class="tab-content active">
  ...
  <!-- TAB 2: IFC EXTRACTION -->
  <section id="tab-ifc" class="tab-content">
